...
Open \texttt{diff.tex} and compile it. After compilation, all changes between the two versions are highlighted in the output document. Note that highlights are only shown when compiling \texttt{diff.tex}. Compiling \texttt{main.tex} will produce the clean version without any highlighted differences.
