...
\usepackage{xcolor}
% Definiere Farbe für Änderungen nach Korrektur
...
\begin{document}
	...
	\input{Kapitel/A02_Eidesstaatliche_Erklaerung}
	\newpage
	...
	% Kurzfassung
	\input{Kapitel/A04_Kurzfassung}
	\newpage

	% Inhaltsverzeichnis
	\input{Kapitel/A05_Inhaltsverzeichnis}
	\newpage
	...
	% Kapitel Einleitung
	\input{Kapitel/B01_Einleitung}
	\newpage
	
	% Kapitel Leitfaden zum Verfassen von Abschlussarbeiten
	\input{Kapitel/B02_Leitfaden zum Verfassen von Abschlussarbeiten}
	\newpage
	
	% Kapitel Datenquellen
	\input{Kapitel/B02_Datenquellen}
	\newpage
	
	% Kapitel Quellenangaben
	\input{Kapitel/B03_Quellenangaben}
	\newpage
	
	% Kapitel Zusammenfassung
	\input{Kapitel/B04_Zusammenfassung}
	\newpage
	...
	\input{Kapitel/C01_Abkuerzungsverzeichnis}
	\newpage
	
	% Abbildungsverzeichnis, TabeLiteraturverzeichnis & Literaturverzeichnis
	\input{Kapitel/C02_Literaturverzeichnis}
